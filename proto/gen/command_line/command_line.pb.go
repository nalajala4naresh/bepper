...
// 	protoc        (unknown)
// source: command_line/command_line.proto

package command_line

import (
	option_filters "github.com/nalajala4naresh/bepper/proto/gen/option_filters"
...
func (x *CommandLine) Reset() {
	*x = CommandLine{}
	mi := &file_command_line_command_line_proto_msgTypes[0]
...
func (*CommandLine) Descriptor() ([]byte, []int) {
	return file_command_line_command_line_proto_rawDescGZIP(), []int{0}
}
...
func (x *CommandLineSection) Reset() {
	*x = CommandLineSection{}
	mi := &file_command_line_command_line_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CommandLineSection) Descriptor() ([]byte, []int) {
	return file_command_line_command_line_proto_rawDescGZIP(), []int{1}
}
...
func (x *ChunkList) Reset() {
	*x = ChunkList{}
	mi := &file_command_line_command_line_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChunkList) Descriptor() ([]byte, []int) {
	return file_command_line_command_line_proto_rawDescGZIP(), []int{2}
}
...
func (x *OptionList) Reset() {
	*x = OptionList{}
	mi := &file_command_line_command_line_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OptionList) Descriptor() ([]byte, []int) {
	return file_command_line_command_line_proto_rawDescGZIP(), []int{3}
}
...
func (x *Option) Reset() {
	*x = Option{}
	mi := &file_command_line_command_line_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Option) Descriptor() ([]byte, []int) {
	return file_command_line_command_line_proto_rawDescGZIP(), []int{4}
}
...
var File_command_line_command_line_proto protoreflect.FileDescriptor

const file_command_line_command_line_proto_rawDesc = "" +
	"\n" +
	"\x1fcommand_line/command_line.proto\x12\fcommand_line\x1a#option_filters/option_filters.proto\"y\n" +
	"\vCommandLine\x12,\n" +
	...
	"\x06source\x18\x06 \x01(\tR\x06sourceB\xaa\x01\n" +
	"\x10com.command_lineB\x10CommandLineProtoP\x01Z8github.com/nalajala4naresh/bepper/proto/gen/command_line\xa2\x02\x03CXX\xaa\x02\vCommandLine\xca\x02\vCommandLine\xe2\x02\x17CommandLine\\GPBMetadata\xea\x02\vCommandLineb\x06proto3"

var (
	file_command_line_command_line_proto_rawDescOnce sync.Once
	file_command_line_command_line_proto_rawDescData []byte
)

func file_command_line_command_line_proto_rawDescGZIP() []byte {
	file_command_line_command_line_proto_rawDescOnce.Do(func() {
		file_command_line_command_line_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_command_line_command_line_proto_rawDesc), len(file_command_line_command_line_proto_rawDesc)))
	})
	return file_command_line_command_line_proto_rawDescData
}

var file_command_line_command_line_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_command_line_command_line_proto_goTypes = []any{
...
var file_command_line_command_line_proto_depIdxs = []int32{
...
func init() { file_command_line_command_line_proto_init() }
func file_command_line_command_line_proto_init() {
	if File_command_line_command_line_proto != nil {
		return
	}
	file_command_line_command_line_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_command_line_command_line_proto_rawDesc), len(file_command_line_command_line_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_command_line_command_line_proto_goTypes,
		DependencyIndexes: file_command_line_command_line_proto_depIdxs,
		MessageInfos:      file_command_line_command_line_proto_msgTypes,
	}.Build()
	File_command_line_command_line_proto = out.File
	file_command_line_command_line_proto_goTypes = nil
	file_command_line_command_line_proto_depIdxs = nil
}
