...
// 	protoc        (unknown)
// source: option_filters/option_filters.proto
...
func (OptionEffectTag) Descriptor() protoreflect.EnumDescriptor {
	return file_option_filters_option_filters_proto_enumTypes[0].Descriptor()
}

func (OptionEffectTag) Type() protoreflect.EnumType {
	return &file_option_filters_option_filters_proto_enumTypes[0]
}
...
func (OptionEffectTag) EnumDescriptor() ([]byte, []int) {
	return file_option_filters_option_filters_proto_rawDescGZIP(), []int{0}
}
...
func (OptionMetadataTag) Descriptor() protoreflect.EnumDescriptor {
	return file_option_filters_option_filters_proto_enumTypes[1].Descriptor()
}

func (OptionMetadataTag) Type() protoreflect.EnumType {
	return &file_option_filters_option_filters_proto_enumTypes[1]
}
...
func (OptionMetadataTag) EnumDescriptor() ([]byte, []int) {
	return file_option_filters_option_filters_proto_rawDescGZIP(), []int{1}
}

var File_option_filters_option_filters_proto protoreflect.FileDescriptor

const file_option_filters_option_filters_proto_rawDesc = "" +
	"\n" +
	"#option_filters/option_filters.proto\x12\aoptions*\xea\x02\n" +
	...
	"\x10NON_CONFIGURABLE\x10\b\"\x04\b\x05\x10\x05\"\x04\b\x06\x10\x06\"\x04\b\a\x10\a*%TRIGGERED_BY_ALL_INCOMPATIBLE_CHANGES*\x17EXPLICIT_IN_OUTPUT_PATH*\tIMMUTABLEB\x99\x01\n" +
	"\vcom.optionsB\x12OptionFiltersProtoP\x01Z:github.com/nalajala4naresh/bepper/proto/gen/option_filters\xa2\x02\x03OXX\xaa\x02\aOptions\xca\x02\aOptions\xe2\x02\x13Options\\GPBMetadata\xea\x02\aOptionsb\x06proto3"

var (
	file_option_filters_option_filters_proto_rawDescOnce sync.Once
	file_option_filters_option_filters_proto_rawDescData []byte
)

func file_option_filters_option_filters_proto_rawDescGZIP() []byte {
	file_option_filters_option_filters_proto_rawDescOnce.Do(func() {
		file_option_filters_option_filters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_option_filters_option_filters_proto_rawDesc), len(file_option_filters_option_filters_proto_rawDesc)))
	})
	return file_option_filters_option_filters_proto_rawDescData
}

var file_option_filters_option_filters_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_option_filters_option_filters_proto_goTypes = []any{
	(OptionEffectTag)(0),   // 0: options.OptionEffectTag
	(OptionMetadataTag)(0), // 1: options.OptionMetadataTag
}
var file_option_filters_option_filters_proto_depIdxs = []int32{
...
func init() { file_option_filters_option_filters_proto_init() }
func file_option_filters_option_filters_proto_init() {
	if File_option_filters_option_filters_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_option_filters_option_filters_proto_rawDesc), len(file_option_filters_option_filters_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_option_filters_option_filters_proto_goTypes,
		DependencyIndexes: file_option_filters_option_filters_proto_depIdxs,
		EnumInfos:         file_option_filters_option_filters_proto_enumTypes,
	}.Build()
	File_option_filters_option_filters_proto = out.File
	file_option_filters_option_filters_proto_goTypes = nil
	file_option_filters_option_filters_proto_depIdxs = nil
}
