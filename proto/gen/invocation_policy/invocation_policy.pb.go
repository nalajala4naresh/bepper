...
// 	protoc        (unknown)
// source: invocation_policy/invocation_policy.proto

package invocation_policy

import (
	strategy_policy "github.com/nalajala4naresh/bepper/proto/gen/strategy_policy"
...
func (SetValue_Behavior) Descriptor() protoreflect.EnumDescriptor {
	return file_invocation_policy_invocation_policy_proto_enumTypes[0].Descriptor()
}

func (SetValue_Behavior) Type() protoreflect.EnumType {
	return &file_invocation_policy_invocation_policy_proto_enumTypes[0]
}
...
func (SetValue_Behavior) EnumDescriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *InvocationPolicy) Reset() {
	*x = InvocationPolicy{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[0]
...
func (*InvocationPolicy) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{0}
}
...
func (x *FlagPolicy) Reset() {
	*x = FlagPolicy{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FlagPolicy) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{1}
}
...
func (x *SetValue) Reset() {
	*x = SetValue{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetValue) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{2}
}
...
func (x *UseDefault) Reset() {
	*x = UseDefault{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UseDefault) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *DisallowValues) Reset() {
	*x = DisallowValues{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DisallowValues) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{4}
}
...
func (x *AllowValues) Reset() {
	*x = AllowValues{}
	mi := &file_invocation_policy_invocation_policy_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AllowValues) Descriptor() ([]byte, []int) {
	return file_invocation_policy_invocation_policy_proto_rawDescGZIP(), []int{5}
}
...
var File_invocation_policy_invocation_policy_proto protoreflect.FileDescriptor

const file_invocation_policy_invocation_policy_proto_rawDesc = "" +
	"\n" +
	")invocation_policy/invocation_policy.proto\x12\x17blaze.invocation_policy\x1a%strategy_policy/strategy_policy.proto\"\xac\x01\n" +
	...
	"\vuse_default\x18\x04 \x01(\v2#.blaze.invocation_policy.UseDefaultH\x00R\n" +
	"useDefaultB\x13\n" +
	"\x11replacement_valueJ\x04\b\x02\x10\x03B\xec\x01\n" +
	"\x1bcom.blaze.invocation_policyB\x15InvocationPolicyProtoP\x01Z=github.com/nalajala4naresh/bepper/proto/gen/invocation_policy\xa2\x02\x03BIX\xaa\x02\x16Blaze.InvocationPolicy\xca\x02\x16Blaze\\InvocationPolicy\xe2\x02\"Blaze\\InvocationPolicy\\GPBMetadata\xea\x02\x17Blaze::InvocationPolicy"

var (
	file_invocation_policy_invocation_policy_proto_rawDescOnce sync.Once
	file_invocation_policy_invocation_policy_proto_rawDescData []byte
)

func file_invocation_policy_invocation_policy_proto_rawDescGZIP() []byte {
	file_invocation_policy_invocation_policy_proto_rawDescOnce.Do(func() {
		file_invocation_policy_invocation_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_invocation_policy_invocation_policy_proto_rawDesc), len(file_invocation_policy_invocation_policy_proto_rawDesc)))
	})
	return file_invocation_policy_invocation_policy_proto_rawDescData
}

var file_invocation_policy_invocation_policy_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_invocation_policy_invocation_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_invocation_policy_invocation_policy_proto_goTypes = []any{
...
var file_invocation_policy_invocation_policy_proto_depIdxs = []int32{
...
func init() { file_invocation_policy_invocation_policy_proto_init() }
func file_invocation_policy_invocation_policy_proto_init() {
	if File_invocation_policy_invocation_policy_proto != nil {
		return
	}
	file_invocation_policy_invocation_policy_proto_msgTypes[1].OneofWrappers = []any{
		(*FlagPolicy_SetValue)(nil),
		(*FlagPolicy_UseDefault)(nil),
		(*FlagPolicy_DisallowValues)(nil),
		(*FlagPolicy_AllowValues)(nil),
	}
	file_invocation_policy_invocation_policy_proto_msgTypes[4].OneofWrappers = []any{
		(*DisallowValues_NewValue)(nil),
		(*DisallowValues_UseDefault)(nil),
	}
	file_invocation_policy_invocation_policy_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_invocation_policy_invocation_policy_proto_rawDesc), len(file_invocation_policy_invocation_policy_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_invocation_policy_invocation_policy_proto_goTypes,
		DependencyIndexes: file_invocation_policy_invocation_policy_proto_depIdxs,
		EnumInfos:         file_invocation_policy_invocation_policy_proto_enumTypes,
		MessageInfos:      file_invocation_policy_invocation_policy_proto_msgTypes,
	}.Build()
	File_invocation_policy_invocation_policy_proto = out.File
	file_invocation_policy_invocation_policy_proto_goTypes = nil
	file_invocation_policy_invocation_policy_proto_depIdxs = nil
}
