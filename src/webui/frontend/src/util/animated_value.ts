// Ported near-verbatim from BuildBuddy's app/util/animated_value.ts (MIT licensed):
// https://github.com/buildbuddy-io/buildbuddy/blob/master/app/util/animated_value.ts
