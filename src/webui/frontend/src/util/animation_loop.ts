// Ported near-verbatim from BuildBuddy's app/util/animation_loop.ts (MIT licensed):
// https://github.com/buildbuddy-io/buildbuddy/blob/master/app/util/animation_loop.ts
