// Ported near-verbatim from BuildBuddy's app/terminal/terminal.tsx (MIT licensed):
// https://github.com/buildbuddy-io/buildbuddy/blob/master/app/terminal/terminal.tsx
